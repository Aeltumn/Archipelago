...
def createForChecks(subLevelName, levelName, checks: Checks, tech: Tech):
    ...
    for lum in checks.regularLums:
        create(subLevelName, levelName, lum, "Lum", ItemClassification.progression_deprioritized_skip_balancing, tech)

    # Create checks for all super lums
    for superLum in checks.superLums:
        create(subLevelName, levelName, superLum, "Super Lum", ItemClassification.progression_deprioritized_skip_balancing, tech)

    # Create checks for all cages
    for cage in checks.cages:
        create(subLevelName, levelName, cage, "Cage", ItemClassification.progression_deprioritized_skip_balancing, tech)
